...
## Project Description
This Project is a chess game developed in Java completely, featuring a Graphical User Interface where two players can play a chess game.
...
### Prerequisites
* To run this application, you need to have Java and Java Development Kit(JDK) 17 pre-installed on your computer.
...
2. To run the application via maven commands follow these instructions:
   ...
   * Clean the repository using the command:<br>
     ```mvn clean```
   * Build the project using the command:<br>
     ```mvn package```
